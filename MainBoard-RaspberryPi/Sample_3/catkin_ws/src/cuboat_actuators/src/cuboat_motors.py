...
class CuBoat():
    ...
    def propeller_cb(self, propeller):
        ...
        self.thruster_speed = [propeller.front, propeller.right, propeller.back, propeller.left]
        
        self.ser.write(bytes.fromhex(bytes([255, propeller.front//100, propeller.front%100, \
        propeller.right//100, propeller.right%100, \
        propeller.back//100, propeller.back%100, \
        propeller.left//100, propeller.left%100, 250]).hex())) # head: 255 0xff, tail: 250 0xfa        
