...
class CuBoat():
    ...
    def move(self, action):
        # action is a string
        if (action == "forward"):
            self.propeller(stop, stop, push_back, push_forward+65)
            print("Forward.")
        if (action == "backward"):
            self.propeller(stop, stop, push_forward+50, push_back)
            print("Backward.")
        if (action == "leftward"):
            self.propeller(push_back, push_forward-120, stop, stop)
            print("Leftward.")
        if (action == "rightward"):
            self.propeller(push_forward-125, push_back, stop, stop)
            print("Rightward.")
        if (action == "turnleft"):
