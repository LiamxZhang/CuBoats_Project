...
class servoActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = servoGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new servoActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = servoGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new servoGoal()
    }
...
module.exports = servoActionGoal;
