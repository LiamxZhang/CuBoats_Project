...
class servoActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new servoFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = servoFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new servoActionFeedback(null);
    ...
    data.feedback = servoFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new servoActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = servoFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new servoFeedback()
    }
...
module.exports = servoActionFeedback;
