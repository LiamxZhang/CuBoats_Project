...
class PIDcontroller():
    def __init__(self, pid_fb=None, pid_sd=None, pid_orient=None):
        ...
        #self.target_subscriber = rospy.Subscriber('pid_target_topic', pid_target, self.control)
        #self.calibration()
        #
        rospy.spin()
    ...
    def control(self):
        ...
        pwm_front = pid_norm(median - control_side - control_orient)
        pwm_back = pid_norm(median + control_side - control_orient)
        pwm_left = pid_norm(median - control_fb)
        pwm_right = pid_norm(median + control_fb)
