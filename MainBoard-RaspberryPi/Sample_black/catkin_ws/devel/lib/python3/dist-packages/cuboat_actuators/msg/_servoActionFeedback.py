...
"""autogenerated by genpy from cuboat_actuators/servoActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class servoActionFeedback(genpy.Message):
  _md5sum = "feaf4784a4883f1a9e572cb6987bc2ca"
  _type = "cuboat_actuators/servoActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','cuboat_actuators/servoFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(servoActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = cuboat_actuators.msg.servoFeedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = cuboat_actuators.msg.servoFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self.feedback.complete_percentage
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.feedback.complete_percentage,) = _get_struct_f().unpack(str[start:end])
      return self
