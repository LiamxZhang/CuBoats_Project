...
class CuBoat():
    ...
    def move(self, action):
        ...
        if (action == "forward"):
            ...
            print("Forward.")
        if (action == "backward"):
            self.propeller(stop, stop, push_forward+65, push_back)
            print("Backward.")
        if (action == "leftward"):
            self.propeller(push_forward+65, push_back, stop, stop)
            print("Leftward.")
        if (action == "rightward"):
            self.propeller(push_back, push_forward+65, stop, stop)
            print("Rightward.")
        if (action == "turnleft"):
